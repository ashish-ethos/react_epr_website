...
function PremiumProperties() {
  ...
  return (
    <div
      className="premium-properties-main h-full bg-gradient-to-br from-gray-900 to-gray-800 sm:py-8 py-16 px-4 relative overflow-hidden laptop-mode-screen"
    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="text-center mb-10 mobile-premium-section">
          <h1 className="mobile-title-text text-5xl md:text-6xl font-[Montserrat] font-medium mb-4 bg-gradient-to-r from-[#c2c6cb] via-[#c99913] to-[#c2c6cb] bg-clip-text text-transparent animate-pulse">
          ...
          <p className="mobile-subtitle-text text-xl font-bebas text-[#c2c6cb] font-medium mt-6 max-w-2xl mx-auto">
