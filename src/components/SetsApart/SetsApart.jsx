  ...
  return (
    <div className="relative bg-gradient-to-br from-gray-900 via-[#333] to-gray-800 py-10 px-4" id="sets-apart">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center mb-16">
        <h2 className="mobile-title-text text-4xl md:text-5xl font-medium mb-4 bg-gradient-to-r from-[#c2c6cb] via-[#c99913] to-[#c2c6cb] bg-clip-text text-transparent">
          What Sets Us Apart
        </h2>
        <div className="h-1 bg-gradient-to-r from-transparent via-[#c99913] to-transparent rounded-full w-full mx-auto"></div>
      </div>
